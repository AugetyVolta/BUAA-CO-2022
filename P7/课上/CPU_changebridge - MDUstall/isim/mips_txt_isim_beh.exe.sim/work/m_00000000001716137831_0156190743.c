...
#endif
static const char *ng0 = "D:/Desktop/class/CPU_changebridge - MDUstall/Bridge.v";
...
LAB78:    t349 = (t0 + 9128);
    ...
    *((unsigned int *)t360) = (t362 | t356);
    xsi_driver_vfirst_trans(t349, 0, 3);
    t363 = (t0 + 8440);
    *((int *)t363) = 1;
...
LAB83:    if (*((unsigned int *)t200) < *((unsigned int *)t199))
        goto LAB82;

LAB81:    *((unsigned int *)t201) = 1;
...
LAB89:    memcpy(t231, t205, 8);

LAB90:    memset(t263, 0, 8);
    t264 = (t231 + 4);
...
LAB108:    memcpy(t301, t263, 8);

LAB109:    memset(t198, 0, 8);
    t333 = (t301 + 4);
...
LAB122:    if (*((unsigned int *)t333) != 0)
        goto LAB123;

LAB124:    t340 = (t198 + 4);
    t341 = *((unsigned int *)t198);
    t342 = *((unsigned int *)t340);
    t343 = (t341 || t342);
    if (t343 > 0)
        goto LAB125;

LAB126:    t345 = *((unsigned int *)t198);
    t346 = (~(t345));
...
LAB128:    if (*((unsigned int *)t340) > 0)
        goto LAB129;

LAB130:    if (*((unsigned int *)t198) > 0)
        goto LAB131;

LAB132:    memcpy(t197, t350, 8);

LAB133:    goto LAB73;

LAB74:    xsi_vlog_unsigned_bit_combine(t3, 4, t192, 4, t197, 4);
    goto LAB78;
...
LAB95:    if (*((unsigned int *)t218) > *((unsigned int *)t217))
        goto LAB94;
...
LAB97:    if (*((unsigned int *)t224) != 0)
        goto LAB98;

LAB99:    t232 = *((unsigned int *)t205);
...
LAB125:    t344 = ((char*)((ng8)));
    goto LAB126;

LAB127:    t349 = (t0 + 2488U);
    t350 = *((char **)t349);
    goto LAB128;

LAB129:    xsi_vlog_unsigned_bit_combine(t197, 4, t344, 4, t350, 4);
    goto LAB133;

LAB131:    memcpy(t197, t344, 8);
    goto LAB133;
...
extern void work_m_00000000001716137831_0156190743_init()
{
	static char *pe[] = {(void *)Cont_48_0,(void *)Cont_50_1,(void *)Cont_52_2,(void *)Cont_54_3,(void *)Cont_56_4,(void *)Cont_58_5,(void *)Cont_60_6,(void *)Cont_62_7,(void *)Cont_64_8,(void *)Cont_68_9,(void *)Cont_72_10,(void *)Cont_74_11};
	xsi_register_didat("work_m_00000000001716137831_0156190743", "isim/mips_txt_isim_beh.exe.sim/work/m_00000000001716137831_0156190743.didat");
