...
#endif
static const char *ng0 = "D:/Desktop/CO/P7/CPU/Bridge.v";
...
LAB106:    t270 = (t198 + 4);
    t271 = *((unsigned int *)t198);
    t272 = *((unsigned int *)t270);
    t273 = (t271 || t272);
    if (t273 > 0)
        goto LAB107;

LAB108:    t275 = *((unsigned int *)t198);
    t276 = (~(t275));
...
LAB112:    if (*((unsigned int *)t198) > 0)
        goto LAB113;

LAB114:    memcpy(t197, t280, 8);
...
LAB107:    t274 = ((char*)((ng8)));
    goto LAB108;

LAB109:    t279 = (t0 + 2488U);
    t280 = *((char **)t279);
    goto LAB110;

LAB111:    xsi_vlog_unsigned_bit_combine(t197, 4, t274, 4, t280, 4);
    goto LAB115;

LAB113:    memcpy(t197, t274, 8);
    goto LAB115;
