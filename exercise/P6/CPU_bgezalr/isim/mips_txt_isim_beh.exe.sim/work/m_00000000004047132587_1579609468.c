...
#endif
static const char *ng0 = "D:/Desktop/CO/exercise/P6/CPU_bgezalr/CMP.v";
...
LAB142:    t304 = (t0 + 1048U);
    t305 = *((char **)t304);
    t304 = ((char*)((ng1)));
    memset(t307, 0, 8);
    xsi_vlog_signed_greatereq(t307, 32, t305, 32, t304, 32);
    goto LAB143;

LAB144:    t312 = ((char*)((ng1)));
    goto LAB145;

LAB146:    xsi_vlog_unsigned_bit_combine(t272, 1, t307, 1, t312, 1);
    goto LAB150;

LAB148:    memcpy(t272, t307, 8);
    goto LAB150;
