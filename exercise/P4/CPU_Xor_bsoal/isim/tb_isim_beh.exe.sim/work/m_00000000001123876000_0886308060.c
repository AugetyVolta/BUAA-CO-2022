...
#endif
static const char *ng0 = "D:/Desktop/CO/exercise/P4/CPU_Xor/ALU.v";
...
LAB20:    t383 = (t0 + 4064);
    ...
    t387 = *((char **)t386);
    memcpy(t387, t3, 8);
    xsi_driver_vfirst_trans(t383, 0, 31);
    t388 = (t0 + 3856);
    *((int *)t388) = 1;
...
LAB106:    t296 = (t0 + 1048U);
    t297 = *((char **)t296);
    t296 = (t0 + 1208U);
    t298 = *((char **)t296);
    memset(t299, 0, 8);
    xsi_vlog_signed_arith_rshift(t299, 32, t297, 32, t298, 32);
    goto LAB107;

LAB108:    t296 = (t0 + 1368U);
    t306 = *((char **)t296);
    t296 = ((char*)((ng7)));
    memset(t307, 0, 8);
    t308 = (t306 + 4);
...
LAB126:    if (*((unsigned int *)t330) > 0)
        goto LAB127;

LAB128:    if (*((unsigned int *)t305) > 0)
        goto LAB129;

LAB130:    memcpy(t304, t344, 8);

LAB131:    goto LAB109;

LAB110:    xsi_vlog_unsigned_bit_combine(t263, 32, t299, 32, t304, 32);
    goto LAB114;

LAB112:    memcpy(t263, t299, 8);
    goto LAB114;
...
LAB123:    t334 = (t0 + 1048U);
    t335 = *((char **)t334);
    t334 = (t0 + 1208U);
    t336 = *((char **)t334);
    memset(t337, 0, 8);
    t334 = (t335 + 4);
    if (*((unsigned int *)t334) != 0)
        goto LAB133;
...
LAB136:    if (*((unsigned int *)t335) < *((unsigned int *)t336))
        goto LAB134;

LAB135:    goto LAB124;

LAB125:    t346 = (t0 + 1368U);
    t347 = *((char **)t346);
    t346 = ((char*)((ng8)));
    memset(t348, 0, 8);
    t349 = (t347 + 4);
...
LAB138:    *((unsigned int *)t348) = 1;

LAB140:    memset(t345, 0, 8);
    t364 = (t348 + 4);
...
LAB150:    if (*((unsigned int *)t345) > 0)
        goto LAB151;

LAB152:    memcpy(t344, t375, 8);

LAB153:    goto LAB126;

LAB127:    xsi_vlog_unsigned_bit_combine(t304, 32, t337, 32, t344, 32);
    goto LAB131;

LAB129:    memcpy(t304, t337, 8);
    goto LAB131;
...
LAB145:    t375 = (t0 + 1048U);
    t376 = *((char **)t375);
    t375 = (t0 + 1208U);
    t377 = *((char **)t375);
    memset(t378, 0, 8);
    xsi_vlog_unsigned_lshift(t378, 32, t376, 32, t377, 32);
    goto LAB146;

LAB147:    t375 = ((char*)((ng1)));
    goto LAB148;

LAB149:    xsi_vlog_unsigned_bit_combine(t344, 32, t378, 32, t375, 32);
    goto LAB153;

LAB151:    memcpy(t344, t378, 8);
    goto LAB153;
