...
#endif
static const char *ng0 = "D:/Desktop/CO/exercise/P4/CPU_swrr/mips.v";
...
LAB66:    t303 = *((unsigned int *)t128);
    t304 = (~(t303));
    t305 = *((unsigned int *)t241);
    t306 = (t304 || t305);
    if (t306 > 0)
        goto LAB67;
...
LAB65:    t245 = (t0 + 4088U);
    ...
    *((unsigned int *)t248) = (t256 & 3U);
    t257 = ((char*)((ng7)));
    memset(t258, 0, 8);
    xsi_vlog_unsigned_multiply(t258, 32, t247, 32, t257, 32);
    memset(t259, 0, 8);
    xsi_vlog_unsigned_minus(t259, 32, t245, 32, t258, 32);
    memset(t260, 0, 8);
    xsi_vlog_unsigned_lshift(t260, 32, t246, 32, t259, 32);
    t261 = (t0 + 4088U);
    t262 = *((char **)t261);
    t261 = (t0 + 5048U);
    t264 = *((char **)t261);
    ...
    *((unsigned int *)t263) = t267;
    ...
    t269 = (t268 >> 0);
    *((unsigned int *)t261) = t269;
    t270 = *((unsigned int *)t263);
    *((unsigned int *)t263) = (t270 & 3U);
    t271 = *((unsigned int *)t261);
    *((unsigned int *)t261) = (t271 & 3U);
    t272 = ((char*)((ng7)));
    memset(t273, 0, 8);
    xsi_vlog_unsigned_multiply(t273, 32, t263, 32, t272, 32);
    memset(t274, 0, 8);
    xsi_vlog_unsigned_rshift(t274, 32, t262, 32, t273, 32);
...
LAB69:    xsi_vlog_unsigned_bit_combine(t127, 32, t275, 32, t308, 32);
    goto LAB73;

LAB71:    memcpy(t127, t275, 8);
    goto LAB73;

LAB74:    t287 = *((unsigned int *)t275);
...
LAB48:    t113 = ((char*)((ng1)));
    ...
    *((unsigned int *)t115) = (t123 & 65535U);
    xsi_vlogtype_concat(t112, 32, 32, 2U, t114, 16, t113, 16);
    goto LAB49;
...
extern void work_m_00000000001609085598_3877310806_init()
{
	static char *pe[] = {(void *)Cont_60_0,(void *)Cont_64_1,(void *)Cont_72_2,(void *)Cont_73_3,(void *)Cont_81_4,(void *)Cont_89_5};
	xsi_register_didat("work_m_00000000001609085598_3877310806", "isim/tb_isim_beh.exe.sim/work/m_00000000001609085598_3877310806.didat");
