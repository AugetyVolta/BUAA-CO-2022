...
#endif
static const char *ng0 = "D:/Desktop/CO/exercise/P4/CPU_ssze/ALU.v";
...
LAB20:    t389 = (t0 + 4808);
    ...
    t393 = *((char **)t392);
    memcpy(t393, t3, 8);
    xsi_driver_vfirst_trans(t389, 0, 31);
    t394 = (t0 + 4600);
    *((int *)t394) = 1;
...
LAB123:    if (*((unsigned int *)t317) > 0)
        goto LAB124;

LAB125:    if (*((unsigned int *)t292) > 0)
        goto LAB126;

LAB127:    memcpy(t291, t331, 8);

LAB128:    goto LAB106;

LAB107:    xsi_vlog_unsigned_bit_combine(t251, 32, t286, 32, t291, 32);
    goto LAB111;
...
LAB133:    if (*((unsigned int *)t322) < *((unsigned int *)t323))
        goto LAB131;

LAB132:    goto LAB121;

LAB122:    t333 = (t0 + 1368U);
    t334 = *((char **)t333);
    t333 = ((char*)((ng11)));
    memset(t335, 0, 8);
    t336 = (t334 + 4);
...
LAB149:    memcpy(t331, t388, 8);

LAB150:    goto LAB123;

LAB124:    xsi_vlog_unsigned_bit_combine(t291, 32, t324, 32, t331, 32);
    goto LAB128;

LAB126:    memcpy(t291, t324, 8);
    goto LAB128;
...
LAB152:    *((unsigned int *)t368) = 1;

LAB154:    goto LAB143;

LAB144:    t388 = ((char*)((ng1)));
    goto LAB145;

LAB146:    xsi_vlog_unsigned_bit_combine(t331, 32, t368, 32, t388, 32);
    goto LAB150;

LAB148:    memcpy(t331, t368, 8);
    goto LAB150;
...
extern void work_m_00000000003465648582_0886308060_init()
{
	static char *pe[] = {(void *)Always_32_0,(void *)Cont_46_1,(void *)Cont_47_2,(void *)Cont_48_3};
	xsi_register_didat("work_m_00000000003465648582_0886308060", "isim/tb_isim_beh.exe.sim/work/m_00000000003465648582_0886308060.didat");
