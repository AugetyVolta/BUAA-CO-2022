...
#endif
static const char *ng0 = "D:/Desktop/CO/exercise/P4/CPU_sh_lh/CMP.v";
...
LAB108:    *((unsigned int *)t232) = 1;

LAB110:    goto LAB99;

LAB100:    t254 = (t0 + 1368U);
    t255 = *((char **)t254);
    t254 = ((char*)((ng6)));
    memset(t256, 0, 8);
    t257 = (t255 + 4);
...
LAB112:    *((unsigned int *)t256) = 1;

LAB114:    memset(t253, 0, 8);
    t272 = (t256 + 4);
...
LAB126:    memcpy(t252, t293, 8);

LAB127:    goto LAB101;

LAB102:    xsi_vlog_unsigned_bit_combine(t190, 1, t232, 1, t252, 1);
    goto LAB106;

LAB104:    memcpy(t190, t232, 8);
    goto LAB106;
...
LAB132:    if (*((unsigned int *)t284) < *((unsigned int *)t285))
        goto LAB131;

LAB130:    *((unsigned int *)t286) = 1;

LAB131:    goto LAB120;

LAB121:    t293 = ((char*)((ng1)));
    goto LAB122;

LAB123:    xsi_vlog_unsigned_bit_combine(t252, 1, t286, 1, t293, 1);
    goto LAB127;

LAB125:    memcpy(t252, t286, 8);
    goto LAB127;
