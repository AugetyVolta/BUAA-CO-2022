...
#endif
static const char *ng0 = "D:/Desktop/CO/exercise/P4/CPU_bszeal/CMP.v";
...
LAB6:    t2 = (t0 + 1048U);
    ...
    t8 = (t7 + 56U);
    t9 = *((char **)t8);
    xsi_vlog_generic_get_index_select_value(t6, 31, t3, t5, 2, t9, 32, 1);
    t10 = ((char*)((ng3)));
    memset(t11, 0, 8);
    t12 = (t6 + 4);
    t13 = (t10 + 4);
...
LAB130:    *((unsigned int *)t268) = 1;

LAB132:    goto LAB121;

LAB122:    t288 = ((char*)((ng1)));
    goto LAB123;

LAB124:    xsi_vlog_unsigned_bit_combine(t231, 1, t268, 1, t288, 1);
    goto LAB128;

LAB126:    memcpy(t231, t268, 8);
    goto LAB128;
...
{
	static char *pe[] = {(void *)Always_30_0,(void *)Cont_44_1};
